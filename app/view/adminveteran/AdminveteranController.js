Ext.define('Admin.view.adminveteran.AdminveteranController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.adminveteran',
    init: function () {
    ...
    formdetailprint: function () {
        ...
        Ext.Ajax.request({
            url: Config.getServices() + '/api/corp/GetVeteranReporting',
            params: {
    ...
    formdetaildelete: function () {
        ...
        Ext.Msg.confirm('Warning', 'Are you sure you want to delete this record?', function (id, value) {
            if (id === 'yes') {
               ...
               // console.log(selectedRecord);
                Ext.Ajax.request({
                    url: Config.getServices() + '/api/corp/DeleteVeteranFormByID',
                    params: {
                        vsid: selectedRecord.data.vsid
                    },
                    method: 'GET',
